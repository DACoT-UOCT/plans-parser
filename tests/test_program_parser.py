...
class TestProgramParser(unittest.TestCase):
    ...
    def test_parse_invalid_program(self):
        self.assertFalse(self.parser.parse_program('00:01:00   ACAS 321 (-00:01 INICIALIZA SPECIAL FACLTY, SABADO)')[0])
        self.assertFalse(self.parser.parse_program('001   PLAN A099180 11 TIMETABLE')[0])
